...
class BookDirectoryTestSuite {
    ...
    void testListBooksWithConditionFragmentShorterThan3() {                          // [1]
        ...
        lenient().when(libraryDatabaseMock.listBooksWithCondition(anyString()))                 // [5]
    ...
    void testListBooksInHandsOfWithZeroBooks(){
        ...
        LibraryUser libraryUser = new LibraryUser("Mateusz", "Dąbrowski","11111111111");
        List<Book> zeroBooksList = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(zeroBooksList);
        //When
    ...
    @Test
    void testListBooksInHandsOfWithOneBooks(){
        //Given
        List<Book> resultListOfOneBooks = generateListOfNBooks(1);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Mateusz", "Dąbrowski","11111111111");
        //When
        List<Book> theListOfOneBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
    ...
    void testListBooksInHandsOfWithFiveBooks(){
        ...
        LibraryUser libraryUser = new LibraryUser("Mateusz", "Dąbrowski","11111111111");
        //When
        List<Book> theListOfFiveBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
        assertEquals(1,theListOfFiveBooks.size());
    }
}